...
public class DashboardBulkUpdateDispatch extends Patch {
    private JSONObject object;

    public DashboardBulkUpdateDispatch(DispatchStatusCallback callback, DashboardBulkAccountEditor editor) {
        super(callback);
        this.object = editor.getFinalized();
    }

    public DashboardBulkUpdateDispatch(DispatchStatusCallback callback, JSONObject object) {
        super(callback);
        this.object = object;
    }
